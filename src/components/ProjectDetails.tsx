...
// import { DarkModeProps } from '@material-ui/core';
...
const ProjectDetails: FunctionComponent<Props> = ({toggleDark}) => {
    ...
    console.log(window.localStorage.getItem('theme'),mode)
                    ...
                    <Paper>
                        <Box marginTop={2} padding={2}>
                            <Typography variant="h6" component="h2">
                                ...
                                <Typography variant="h6" component="p" >{database[paramsId].category}</Typography>
                        ...
                        <Box marginTop={2} padding={2}>
                            <Typography variant="h6" component="h2">
                                ...
                                <Button startIcon={<AccessTimeIcon />} variant="contained" sx={{
                                    borderRadius: '50px',
                                    marginLeft: '20px',
                                }}>{database[paramsId].status}</Button>
                            </Typography>
                        </Box>
                        <Box marginTop={2} padding={2}>
                        ...
                        <Box marginTop={2} padding={2}>
                            <Typography variant="h6" component="h2" sx={{ position: 'relative', width: "230px" }}>
                                <GroupIcon /> Assignee
                                <AvatarGroup max={2} sx={{ position: 'relative', float: 'right' }}>
                                    <Avatar alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
                        ...
                        <Box marginTop={2} padding={2}>
                            <Typography variant="h6" component="h2">
                                ...
                                {project?.label && project?.label?.map((data) => {
                                    return (
                                ...
                                {label.length !== 0 && label.map((label) => {
                                    return (
                                        <Button
                                            variant="contained" sx={{
                                                borderRadius: '50px',
